...
namespace LabManager.DataAccess.Migrations
{
    ...
    [Migration("20211213155905_account_miggration")]
    partial class account_miggration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LabManager.Model.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LabManager.Model.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LabManager.Model.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LabManager.Model.Account", b =>
                {
                    b.HasOne("LabManager.Model.User", "AccountHolder")
                        .WithMany()
            ...
            modelBuilder.Entity("LabManager.Model.Role", b =>
                {
                    b.HasOne("LabManager.Model.Account", null)
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    b.HasOne("LabManager.Model.Role", null)
                        .WithMany()
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LabManager.Model.User", null)
                        .WithMany()
